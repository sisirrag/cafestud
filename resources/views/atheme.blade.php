...
<header id="site-header" class="fixed-top">
  <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark stroke">
          <a class="navbar-brand" href="/ahome">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false" >Payments</a>
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="/afeeview">All Payments</a></li>                
                      <li><hr class="dropdown-divider"></li>
                      <li><a class="dropdown-item" href="/afee">Add Payment</a></li>
                    </ul>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false" style="color:orange">Admin</a>
                    <ul class="dropdown-menu">
          ...
          <div class="d-grid grid-col-4 footer-top-29">
              ...
              <div class="footer-list-29 footer-2">
                  <ul>
                      ...
                      <li><a href="/astud">Our Branches</a></li>
          ...
          <p>We'll never share your email address</p>
              ...
              <div class="footer-list-29 footer-4">
                  <ul>
                      ...
                      <li><a href="/ahome">Home Page</a></li>
                      <li><a href="/aitem">About Us</a></li>
                      <li><a href="/menu">Our Menu</a></li>
                      <li><a href="#blog"> Blog Posts</a></li>
                      <li><a href="/astud">Contact Us</a></li>
                  </ul>
              </div>
          </div>
