            ...
            <div class="grid contact-grids pt-3">
                ...
                <div class="contacts12-main">
                    ...
                    @csrf
                        ...
                        <div>
                            <label class="form-field" for="Day">Day</label class="form-field">
                        ...
                        <div>
                            ...
                            <input type="text" name="Breakfast" id="w3lSubect" value="Breakfast" class="contact-input" />
                        ...
                        <div>
                            ...
                            <input type="text" name="Lunch" id="w3lSubect" value="Lunch" class="contact-input" />
                        ...
                        <div>
                            ...
                            <input type="text" name="Dinner" id="w3lSubect" value="Dinner"class="contact-input" />
